...
// The batch precompute solves every junction in one call at trial start with high
// reasoning, so it legitimately takes longer than an interactive hint. It runs once,
// before the participant needs any cue, so a generous timeout is fine here.
const batchTimeoutMs = 90000;
